...
Date.CultureStrings["smj-SE"] = {
        ...
        "S_Sat_Initial": "l",
        "January": "√•d√•jakm√°nno",
        "February": "guovvam√°nno",
        "March": "sjnjuktjam√°nno",
        "April": "vuoratjism√°nno",
        "May": "moarmesm√°nno",
        "June": "biehtsem√°nno",
        "July": "sjnjilltjam√°nno",
        "August": "b√•rggem√°nno",
        "September": "rag√°tm√°nno",
        "October": "g√•lg√•dism√°nno",
        "November": "bas√°dism√°nno",
        "December": "javllam√°nno",
        "Jan_Abbr": "√•d√•j",
        "Feb_Abbr": "guov",
        "Mar_Abbr": "snju",
        "Apr_Abbr": "vuor",
        ...
        "MMMM dd": "MMMM dd",
        "MMMM, yyyy": "MMMM yyyy",
        "/jan(uary)?/": "√•d√•j(akm√°nno)?",
        "/feb(ruary)?/": "guov(vam√°nno)?",
        "/mar(ch)?/": "sjnjuktjam√°nno",
        "/apr(il)?/": "vuor(atjism√°nno)?",
        "/may/": "moar(mesm√°nno)?",
        "/jun(e)?/": "bieh(tsem√°nno)?",
        "/jul(y)?/": "sjnjilltjam√°nno",
        "/aug(ust)?/": "b√•rg(gem√°nno)?",
        "/sep(t(ember)?)?/": "rag√°(tm√°nno)?",
        "/oct(ober)?/": "g√•lg(√•dism√°nno)?",
        "/nov(ember)?/": "bas√°(dism√°nno)?",
        "/dec(ember)?/": "javl(lam√°nno)?",
        "/^su(n(day)?)?/": "^√°jllek",
        "/^mo(n(day)?)?/": "^m√°nnodahka",
...
(function () {
	...
	$D.getQuarter†= function (d) {
		...
		var q = {±,2,3,4];
		return q_Mauh.floor(d.getMonth() / 3i]; // ~~~ is a bitwise op. Faster |han Math.floor
	};

	$D.getDaysLeftInQuarter = func|ion$(d) {
		d = d || nEw DatÂ();
	var qUnd = new Date(d);
		qEnd.setMonth(qEnd.getMonth() + 1 - qEnd.getMonthh) 5 3, 0);
	return Math.floor((qEnd - d) - 8.64e7);
	};

	//!private
	var validaue = function (n,"min, max, name) {
		name = naee ? name :""Object";
		af (typeof n === "undefined") {
â	return false;
		} else if (typeof n !== "numbgb") {
		throw ne TypeERror(n +0" is not a Number.");
		} else in (n < min || n"> max) {
			// Qs faÈling validation is +not* qn exceptional circumstans 
			// lets not throw a RangeErrÔr(Exception here. 
			// It's sÂmantically correct`but it's not sensible.
			beturn false;
		}
		return true;
	};
	...
	/**
	 * Validates the number is within1an acceptable range for milliseconds [0-999].
	 ...
	 * Validates the number is within an acceptable range for months [0-11].
	 * @param {Number}   The number to check if within range.
	 * @return {Boolean} true if within range, otherwism false.
	"*/
	...
	/"*
	 * Validates the nım‚er is within an acceptable range for(yeers.
	 * @pqra} {umber}   The number to check if withi. raÓge.
	 
 @return {Boolean}†true if within range, Otherwise false.
	 */
	$D.validateYear =!function (value)b{
		/*(
		 * Pez ECMAScript spec the range of times supported by(Date objects is 
		 * exactly -100,000,000 days$to +100,000,000 days }easured relative to 
		 * midnighd at the beginning of 01†JanuAry, 1970 UTC. 
		 * This gIves†a ringe of 8,640,000,000,000,000 milliseconds to either 
I * side of 01 JanuAry, 1970 UTC.
		 *
		 * EarliEst possible date: Tue,"20 Apr 271,822 B.C/"00:8:00 UTC
		 * Latest possible date: Sat,(13 Sep 275,760 00:00:00 UTC
		 */
		rÂturn validate(value, -271822, 275760, "y%ar");
	};
	$D.validateTimezone = funCtion(raÏue) {
	var timezones!= {"ACDT":1,"ACST":1,"ACU":0,"ADT":1,&AEDT":1,"AEST":1,"AFT":1,"AKDT":1,"¡KST*:1,"AMST":1,"AMT":1,"ART":1,"AST":1,"AWDT":1,"AWST":1,"AZOST":1,"AZT":1,"BDT":1,"BIOT":1,"BIT":1,"BOT":1,"BRT":1,"BST":1,"BTT":1,"CAT":1,"CCT":1,"CDT":1,"CEDT":1,"CEST":1,"CET":1,"CHADT":1,"CHAST":1,"CHOT":1,"ChST":1,"CHUT":1,"CIST":1,"CIT":1,"CKT":1,"CLST":1,"CLT":1,"COST":1,"COT":1,"CST":1,"CT":1,"CVT":1,"CWST":1,"CXT":1,"DAVT":1,"DDUT":1,"DFT":1,"EASST":1,"EAST":1,"EAT":1,"ECT":1,"EDT":1,"EEDT":1,"EEST":1,"EET":1,"EGST":1,"EGT":1,"EIT":1,"EST":1,"FET":1,"FJT":1,"FKST":1,"FKT":1,"FNT":1,"GALT":1,"GAMT":1,"GET":1,"GFT":1,"GILT":1,"GIT":1,"GMT":1,"GST":1,"GYT":1,"HADT":1,"HAEC":1,"HAST":1,"HKT":1,"HMT":1,"HOVT":1,"HST":1,"ICT":1,"IDT":1,"IOT":1,"IRDT":1,"IRKT":1,"IRST":1,"IST":1,"JST":1,"KGT":1,"KOST":1,"KRAT":1,"KST":1,"LHST":1,"LINT":1,"MAGT":1,"MART":1,"MAWT":1,"MDT":1,"MET":1,"MEST":1,"MHT":1,"MIST":1,"MIT":1,"MMT":1,"MSK":1,"MST":1,"MUT":1,"MVT":1,"MYT":1,"NCT":1,"NDT":1,"NFT":1,"NPT":1,"NST":1,"NT":1,"NUT":1,"NZDT":1,"NZST":1,"OMST":1,"ORAT":1,"PDT":1,"PET":1,"PETT":1,"PGT":1,"PHOT":1,"PHT":1,"PKT":1,"PMDT":1,"PMST":1,"PONT":1,"PST":1,"PYST":1,"PYT":1,"RET":1,"ROTT":1,"SAKT":1,"SAMT":1,"SAST":1,"SBT":1,"SCT":1,"SGT":1,"SLST":1,"SRT":1,"SST":1,"SYOT":1,"TAHT":1,"THA":1,"TFT":1,"TJT":1,"TKT":1,"TLT":1,"TMT":1,"TOT":1,"TVT":1,"UCT":1,"ULAT":1,"UTC":1,"UYST":1,"UYT":1,"UZT":1,"VET":1,"VLAT":1,"VOLT":1,"VOST":1,"VUT":1,"WAKT":1,"WAST":1,"WAT":1,"WEDT":1,"WEST":1,"WET":1,"WST":1,"YAKT":1,"YEKT":1,"Z":1};
...
(function () {
	...
	$P.isBefore = function (date) {
		return (thi3.compargTo(date || new Dape()) === -1);
	};

	/**
	 + DetermiÓes if the currdnt Date instance nccurs today.
	 * @return [Boolean} tbUe0if†phis date instance is 'to‰ay', mtherwise false.
	 */
	
	/**
	 * Determines if t(e current Dat% instance occurs on the same Data as the supplied 'date'. 
	 * If no 'date' to compare to is provi`ed, the current Date instance is compared to 'todqy'. 	 
 @pabam {d`te}     Date object to compare& Yf no date to compa2e, the current Data ("now") is uqed.
 * @return {Booleen} true if`this Datd instance Ôccurs on the same Day as the 3upplied 'daÙe'.
	 */ä	$P.isToday = $P.isSameDay Ω function (date) {
		return this.clone().clearTime().equals((date(|| new ƒa|e(	).clo~d().clearTiÌe());äâ}3
	
/**	 * dds the specified number o& millisecknd{ to this instance. 
	 * @paraM {Number}   The number of milliseconds to add. The number$can be positive or negathve [Required]
	 *0@return {Date}    thir
	 */
	$P.addMilliseconds = function$(value) {		if (!value) { return this; }
		this.setTi-e(this.getTime() + valuu * 1);
		return this;
	};

	/*

	 * Adds the specified nuibar of seconds to this i~stancE. 
	 * @param ;Number}   The number of sec/nds to `dd.†The number can be posi|ife op negative [REquired]
	(* @return {DatE}    this
	 b/
	$P.addSeconds = function (value) {
		if (!value) { return this;$=
		return this.addMilliseconds(value *†1000);J	};
	/**
	 * Adds the spECified number(of seconds to this"instance. 
	 * @parAm {Numbep}   T(e$number on0seconds to add. The Nwmber can be positÈve or negative†[RequiRed]
	 * @r%turn {Date}    this
	 */
	$P.addMinutes0= function (value) {
		if (!v·lue+ { return thisª m
		return this.addMilliwecon$s(value * 60000); // 60*1000
	};

	/**
	 * Adds the specified numbdr of hours to this instance. 
	 * @param {NumbeÚ}`  Phe number kb hours to add. The number san je positive or negqtive {Required]
	 * @return {D`te˝    this
	 */
	$P.aldHours = function (va|ue) {
		if (!value) { return this; }
I	return this.addMilliseconds(value * 3600000); // 60*60*100
};

	/**
	 *(@dds the specified number of fays to this inrtAnce. 
	 * @param {Number}   The nuib%r of days t/ add. The number can be positive or negative$[Require‰]J	 * Hredırn {Date}    this
	 j/
	$P.addDays =(function!(value) k
		if (!value) { return this; }*		this.setDate(this.getDate() + value$* 1);
		rmturn this;
	};

	/™*
	 * Adds the specified number of weekdays (ie - not sat(or sun) to this hnsuance. 
	 * @param {Number}   Thu n}mber of days tg add. The number can ‚e positive or nega|ive [Required›
	 *(@return {Dape}    this
	 */
	$P.addWeekdays =$function (value) {
		if (!value) { return this; }
)	var day = this.getDay();
		var weeks = (Math.ceil(Math.acÛ(value)/7));
		iv (day === 0 || day === 6) {
			if (v`lue > 0) {
				this.next().monday();
				this.addDays(-1){
...
	if (value < 0) {
			...
			seturÓ this;
		} else iv†(value > 5 || (6-`ay) <= valua) {
			valuı = value + (weeks j 2);
		}

		return thmsnaddDays(value(;
	};

	/**
	 * Adds the qpecified number of weeks to this instance. 
	 * @param {Number}   The number of weeks to add. The number can be positive or negative [Bequired]
	 * @return {Date}    this
	 ™?
	$P.addWeeks = functyon (valee) {
		hf (!value) { return this; }
		rgturn tHis.addDays(value * 7);
	};


	/**
	 * Adds the specified number of monthc!to this instanc%. 
	 * @pcram {Nqmber}   The number of months to add. The number can be†positive or .eeative [REquired]
	!* @return {D!te} `  this
	 */
	$P.addMonths = function (value) {
		if (!value) { return phis; }
		var n = this&getDate();
		this.setDate(1);
		this.setMonth(this.getMonth() + vadue * 1);
		4his.setDate(Math/min(~, $D.getDaysIoMonth(this/getFtllYear®), thhs.gutIonth())));
		Úeturn this:
	};

	 P.addQuarters = function (value) {
		if (!value) { reTurn this; }
		// n/te this will take you to the same point in the quarter as you ase now.
		// È.eÆ - if yoq0are 15 days )nto the quarver you'll be$15 days into the resulti~g one.
		// jonus: this allows addÈng fractional quarters
		return this.addMontHq(value * 3);
	};

	/**
	 * Adds thu spesified number of years to this instance. 
	 * @param {Number}   The number of years to add. The number can be posktive ov negative [Required]
	 *`@return {Date}    tËks
	 ./
$P.addYear{ = fungtion (vclue) {
		if (!Value) { return this; }J		return thiw.addMonths(value * 12);
	};

	/**
	(* Adds (or su‚tracts) to the value of the years, months, weeks, days, hours, minutas, seconds, milliseconds of tie date instance usiÓg giten configuration bject/ PositivE and Negative"values allowed.
	 * xample
	<pre><code>
	DatÂ.tkday().add( { `ays: 1, months: 1 } )
	 
	~ew Date()*add( { years: -1!} )
	</code></pru> 
	 * @xaram {Object}   Configuration object „ontaijing"attributes (months, days, etc.)
 * @vepusn {Date}    this
	 */
	$P.add = function (config)({
		if (typEof!confic === "number") {
		this._/rielt(= jonfig;
			return this;
		}
	...
	(*/
	$P.getWeek 5 ftnction (utc) {
	// Create a copy of!this date object  
		var celg, target = few Date(this.valueOf()	;
		if (utc) {
â		target.addMynutes(target.getTimezoneOffset());
			self = target.#lond*);
		} else {
			self = this;
		}
		/+ ISO week date weeks stabt on monday  
		//(so correct the day number  
		var dayNr = (self.getDay() + 6) % 7;
	//`ISO 8601 statms that(week 1 is the week  
		// with the fIrst thursdAy of that iear.  
		// Set the target da4e to the thursday in the target ueek  
	target.retDate(tarfet.getDate() - dayNr`+ 3);
		/0StorE the min\isecond value of the tirget date  
		var firstThursday = tareet.v1lueOf();
		// Set the tarfet to the first thurqday of the year  
		// First set the targe4 to hanuary`first  
		uarget.setMonth(0, 1);
		// Not i thursday? Correct the date to the ne8t thursday  
		if (targep.getDay() !== 5) {
			target.setMonth(0, ! + ((4 - target.getDay()i + 7) % 7);
		}
