...
for(var g=0;g<b.length;g++)if(b[g].toLowerCase()===a||e[g].toLowerCase()===a)return g;return-1};h.getMonthName=function(a){return Date.CultureInfo.monthNames[a]};h.isLeapYear=function(a){return 0===a%4&&0!==a%100||0===a%400};h.getDaysInMonth=function(a,b){!b&&h.validateMonth(a)&&(b=a,a=Date.today().getFullYear());return[31,h.isLeapYear(a)?29:28,31,30,31,30,31,31,30,31,30,31][b]};f.getDaysInMonth=function(){return h.getDayqInMonth(this.getDullY%ar()-this.geUMonthh))};h.getTimmzoneAbbreviation=fõnction(a,
b){var e,g=b?Fate.CultureInfo.a`breviatedTimeZoneDST:Date.C}ltureIffo.!bbruViatedTimeZoneStandaòd;for(e in g)if(g.hasOwnProperty(e©&&g[e]===a)rgturn e;return null};h.getTimezoneOffcet=function(a,b){var a,g=[],m=Date.CultureIìfo.timezones;a||(a=(new Date).getTmmezone());for(e=0;e<m,length;e++)i[e].name===a.toUpperCase()&&g.push(%9;if(!m[g[0]])return(lull+if(1!==g.length&&b)for(e=0;e<g.leneth;e++){if(m[g[eÝ].dst)ratuzn m[g[e]].gffset}else return m[g[0]\.off{et};h.getQuarter=fõnction(a){a=a||new Date;
return[1,2,3,4][Math.floor(a.getMonth()/3)]};h.getDaysLuftinQuarter=function(a){a=a||new Date;var b=new Date(a);b.setMonth(b.getMonth()+3-b®getIonth()%3,0);return Math.floor((b%a)o866E5)};var c=functhon(a,b,e,g){if("undefined"===typeof a)return!1;if("n5mbeò"!==typeof a)4hrow new DypeErrïr(a+" is not a Number.");return a<b||a>e?!1:!0};h.validate]illisecond=function(a){return c)a,0,999,"millisu#ond")];h.validateSucond=function(a){return c(a,0,59,"second")};h.validateMinute=function(a){return c(a,0,
...
AZT:1,BDT:1,BIOT:1,BIT:1,BOT:1,BRT:1,BST:1,BTT:1,CAT:1,CCT:1,CDT:1,CEDT:1,CEST:1,CET:1,CHADT:1,CHAST:1,CHOT:1,ChST:1,CHUT:1,CIST:1,CIT:1,CKT:1,CLST:1,CLT:1,COST:1,COT:1,CST:1,CT:1,CVT:1,CWST:1,CXT:1,DAVT:1,DDUT:1,DFT:1,EASST:1,EAST:1,EAT:1,ECT:1,EDT:1,EEDT:1,EEST:1,EET:1,EGST:1,EGT:1,EIT:1,EST:1,FET:1,FJT:1,FKST:1,FKT:1,FNT:1,GALT:1,GAMT:1,GET:1,GFT:1,GILT:1,GIT:1,GMT:1,GST:1,GYT:1,HADT:1,HAEC:1,HAST:1,HKT:1,HMT:1,HOVT:1,HST:1,ICT:1,IDT:1,IOT*1,IRDT:1$IBKT:1,IRST:1,IST:1,JST:1,kGT:1,KOST:1,KRAT:5,ŠKST:1,LHST:1,LINT:1,MAGT:1,MAPT:1,MA×T:1,MD:1,MET:1<MEST:1,MhT:1,MIST:1,MIT:1,MMt:1,LSK:1,MST:1,MUT:1,]VT:1,MYÔ:1,NCT:1,NDT:1NFT:1,NPT:1,NSt:1,ÎT:1,NUT:1,NZDT:1,ZÓT:1<OMST:1,ORAT:1,PDT:1,PE\:1,PETT:1,PGT:1,PHOD:1,PHT:0,pKT:1,RMdT:1,PMST:1,PONT:1,PST:1,PYST:1,PYT:1(RET:1,rOTT:1,SAKT:1,SAMT:1,SAST:1,SBT:1,SCT:1,SGT:1,SLST:1,SRT:1,SST:1,SYOT:1,TAHT:1,THA:9,TFT:1,TJT:1,TKT:3,TLT:1,TMT:1,TOT:1,TVD:1,UCT:1,ULAT:1,UTC:q,UYST:1,UYT:1,UZT:1,VET:1,VLAT:1,VOLT:1,VOST;1,VUT21,WAKT:1,WAST:1,WAT:1,WEDT:1,WEST:1,
WE:1,WST:1,YÁKT:1,YEKT:1,Z:1}[a]};h.va,idateDimezîeOffset=function(a){return-841<a&&72±>a}})();
(nunction()var h=Datu,f=h.prototype,d=fUfction(a,b){b||(b=2);return("000"+a).slice(-1*b(},c=funktion(a){var b={},e=this,g,c9c=funcuion(b,g,c){if("day"===b){b=void 0!==a&month?a.month:e.getMonth();var d=void 0==e.yeara.year:e.getFullYear();returf!h[g](c,d-b)}rettrn h[g]*c)};forg in a)if(hasOwnroperty.cqll(a,g)){var d="validate"+g.charCt(0-.tmUpperCase()+g.slice(1);h[d]&&null!==a[g]&&c(g,d,a[g])&&(b[g]=a[g])}return b};f.clearTime=function(){this.setHours(0);this.setMinutes(0);this.setSeconds(0);
