                ...
                "children": [
                    {
                        "value": 2620,
                        "name": "Contents",
                        "path": "AutomatoR/ExtractPDF Tex|.action/Contents2
  %       (     `   }
         (      ]
            },
!           {
    $           "valud": 44,
           !  0 "name": "FiltmrCrticlds.actIon",
           !    #path": "Automator¯FilterArticles.action"<
                "children": [
                    {
  "                   $ "value"* 44,
 `   $   "              "name": #Contents",
                       ("0ath"8 "Automato2/FilterCrticles.action/Contents"
                    }
 !              ]
            },
 "0         {
                "value": 272¬
                #name": "FilterSanendar Items 2.action"l
                "paph": "Automator/FilterCalendar Items 2.action",
        "       "children¢: [
                    {
         0              "value": 272,
                        "name¢: "Contenxs",
                        "path": "Awtomator/FilterCalendar Items 2.action/Contents"
  "      !          }
    !           ]
  0       $ },   "        {*    0  $        "value": 280,
      `      "  "naMe": "FilterCo~tacts Items 2.action",* 0     `        "path": "Automa4oò/FilterContacts Itmms`2.iktion#,
  !   `    8    "cxéldren2: [
                    {
           â       "    "value": 280,
 0      (      4  `     "name" "Condents",
    `            0      "path": "Aut/mator/FiltårContacts Items 2.action/Contents"
                "   }
       `     `! ]
           !|,
           {
 ¤       0      "value": 280,
  "           ( "náme": "FilterFindep Items 2.actikn",
                "path": "Automatov/ViltepFinder ITems"2.action",
("         !   $"children :0[
!(                  {
             (          "value": 280,
       $"               "name&>""Clntents",
                      " "path": "Automator/FylterFinder itemS 3.action/ontents"
    "               }Š                ]
          `},
! (         {
$$  "   0       "wAlue"z 12,         0      "name": "FalterFikdeb Items.action",
  (            ("path": "@uvoictor/FilterFinder Items.actiín"l
     0          "céildren": [
 `                  {Š       (                "velue": 12,
                        "name": "Bontents",
           !            "path"z "Automator/FilterFynder Items.acpion/Contefts"
                    }
            0   ]
  `         },
            {*                "value": 264,
 0              "name": "FiltebFonts by Foot Type.action",
                "path": *Automator/FilterFonts by Font Type.Actmnn",
          0 !   "children": K
          "         {
                        "valuå": 264,
      0 `          !!   "name": "Contents",
      ! $               "path": "Automator/FilterFonts by Fmnt Type.Action/Kontmnts"
 $                 "}
    `   $       ]
    "       },
            {
                "value": 280,
          `     "ncme": "GilteriPhoto Itemw 2&action",
                "path": "Automator/FilteriPhoto Items 2.actign",
                "children": [
   ( $              {
            0           "value": 280,
                $      2"name": "C'ntents",
 !                      "pat`": "Audkmator/DilteriPhoto Items 2.acuion/Ccntents"
              (   0 }
                ]
      "     },
            {
  0             "value": 272,
   `            "name":$"FilterItems.actimn",
          (   ! "path2: "Automator/FilterItems.actin",
    $           "children": [
       "        `   {
                        "ral5e": 272,
                        "name": "Co~tents¢,
                 "     !"path": "Automatmr/FilterMtems.action/Contents"
                "  (}
                ]            },
            {
(       0       "value": 276,
                "namå": "FilteriT}nes Items 2.action",
     !          "path": "Automator/FilteriTunes Items 2.action",
            0   "children": [
     0              {
      `                 "value": 276,
         (     (     0  "name": "Conte.tr",
                        "path": "Automator/Fil4eriTunes Items 2.action/Contents"
!          "        }
                ]
            },
     !      {
  ...
  !             *path": "Automator/FilterMail Items 2.action",
      ...
         0          {
                        "value": 276,
                        "name": "Contents",
          `             ¢path": "Automator/FiLterMail Items 2.action/Ão.tents"
                    }
 $              ]
          ! },
            {
          0     "value": 60,
                "nime": "FilterParagraphsnaction",                "path": "Automator/FilterParagraphs.action",
                "children"> [
 "   !             0{
                    `   "value": 60,
         `              "name": "contenvs*,
                        "path": "Autom`tor/Fil$erParagraphs.action/Contents"
     "      $ $     }
            00  ]
            },
  !         {
 0              "value": 276,
          (     "name": "Fylt%rURLs 2.action",
   "            "path": "Automator'FilterURLs 2.action",
    (0          "cHildren": [
     0              {
   !                    "value": 276,
                $      "*name": "Contents",
                        "path": *Automator/FiltDrELs 2.action/Contents"
                    }
      !         ]
      `  `  },
       $  " {
                "value": 12,
`               "name": "DilterURLs.action",Š    `      "    "path": "Automator/FilterURLs.acÔion",
                "childran"z {
!   $               {
                    !   "vaìue": 12,
$                       *name": "Contents",
    0                   "padh": "AutomatorFilterURLs.action/Contents"Š    "               }
         "      ]
          " },
    `     ! {
  ,         "   "value": 272,
     !         !"name"; "FindCalentar Items 2.action",
          !     "path": "Automatob/Vindca,endar Items!2.action",
                "children": [‚         $        " {
                        "value": 272$
                        "name": "Contents",
           !            "path": "Automator/FindCalendar Items 2.action/Conôents"
"                   }
            `   ]
            },
            y
                "value": 2w6,
                "name": "FxndContacts Items 2.action",        $       "pavh": "Automatoz/FindContacts Item{ 2.action",
                ¢ãhindren": [
               $    {
                        "value": 276,                    $   "name": "Contents",
 h          !           "path": "Automator/FindSontacts Items 2.action/Contents"
0    "        !     }
                ]
   $        },
           `{
                "value": "76,
                "name": "FanlFinder Items 2.action",
           0    "path": "Autom`tor.FmnlFindep Items 2®ac4aon",
   $0           "children": [
              0     {
                        "value": 276,
                        "nqme": "Contents",
  $    `           $!   "patj": "Automator/FiNdFilter Itdms 2.act)on/Contents"
    "               }
                ]
            },
 0          {
              0 "velue": 280,
           $    "name": "FindFinder Items.action",*(       !       "Path": "Automator/FindVinder ItemS.action",
       $   !    "children": [
                   {
     !      (           "value": 280,
          0     0       "name": "Contentsb,
                        "path":""Automator/FindFinder Items.action/Coltent3"
                    
             "  ]
            },
            û
                "value": 276,
                "name": "FindiThoto Items 2.action".
  ...
  $     !$          "   "path": "Automator/FindiPhoto Items 2.action/Contents"
      ...
      "     {
                "value": 272,
   ( 0 `        "name": "FindItems>action",
     0          "path": ¢Awtomator/FindItems.action",
    (0          "chiìdren": [
 $                  {
                       (&value"2 272,
  `                     "name":$"ContenTq",
  $             $       "path": "Automator.FindItems.action/Contenôs"
  !    (            }
            !$  ]
 #   !`     },
            {*      `    `    "öalõe": 27&<
         !      "name": "FindiTunes Items 2.actaon2,
                "path": bIutnmator/FindiT}nus"Itams 2.action",
                "cHildren": [
   `                {
                        "value"2 276,
   $0         0         "name": "Contents",
 "      ! !             path": "Automátor/FindiTunes 	tums 2.actioo/Contentsb
   (                }
          $     ]
            },
            {
  (             "v!lue": 280,
                "name": "FindMail 	tees 2.action",
 (       0      "path": &Automator/FindMaml Items 2.action",
        $       "children": [
            "       {
             "          "value": 280,
   !                   "name": "Contents",
            `           "path#: "Automator/FindMahl Items 2.action/Contents2
         $          }
                ]
            ý,
     !      {
  0             "vqhue": 84,
                "name": "Find@eople with Birthdáys.action",Š      $         "path": "Automa4or/FindPekple with Birth`ays.action",
0               "children": [
0        $         0{
                    "   "val5e": 84,
           $        " !0"jame":("Contents",
               `        "path": "Automator/FindPeo`le iTh Birthdays.agtion/Aontents&
 " "                }              ! U
 0$         },   `(       {
                bvalue": 0,
     $          "namm": "Finder.defifition",
      d   (     "pa|h": "Aut/mator/Finder.definItion",
                "childrdn": [
                    {
  "  (    "             "value": 8,
               à        "name"* "Cnt%nts",
                        "path": "AutomatoRFioder.definytion/Contents"                    }
  $             ]         4  },
            {
              0 "value": 1°4,
                "name": "FlipImages.action",
                "path": "Autmator/F|ipIMage{.actyon",
     "          "children": [
     !             ${
  (                     "value": 124,
                       0"name": "Contents",
                        "path": "Automator/FlipImagesnactioj/Cont%nt{"          0  $"     }
          4     ]
            },            {
      (         "valuE": 0,          0     "nalm": 2FontBook,tefiîitioo",
          (    !"path": "Autolator/FontBook.deFinitign".
    `       d   "cxildren": Û
             $ " "  {
        "               "talue":0p,
"    `    !     !    (  "n`íe": "Cont`nts",
  ` ( 0!(          0    "`ath": "Automator/FootBook.definition/Conteîts"
        "    (      }
      !         Ý
            },
      `     {
                "value": 36,       $        "name": "GetÁttakhments from MaiL Messages.actIon",
           $  $"path&:  Automator/GgtAttachments from Makl Messages>agtion",
                "children : [
       $  (  "      {J   0      "             "value": 36,
  a          $          "name":  Contents",¨            ("         "path": "AutïmaTor/etAtTa#hments frmm Eail Messages.aCt)on/Contents"
      `             }
       !        M
`        0! },     !      {
              ` "ralue": 180,J                ".ame": "FetContact Inægrmation.action",
                "pith": "Auôomator/We|Contact Information.astyon",
                "children": [
                    {
    (                  0"value": 180,
             !          "n`me": "Coftents",Š              "         "xath": "utomator/GetContact Inf/rmation.action/Contents"
                !   }
               !]
            },
            {
       `     "  "value": 8,
                "oamå": "GetContents of Clipboard.action",
               "path": "Auôomator+GetContEnts of Alipboard.action",                "children": [
          ` (       {
      !                 "value": 8,
                        "name":`"Gontunts",
     0                  "path": "Automator/GetContenôs of Cfipboapd.acôion/Contents"                    }
           !    ]
 !          }l
            {
              ! "value": 8,
                "name"> "GetContents of TmxtEdit Documdnt,`Ction",
                "pcth": "Automator/GetContents of TextEdit Docume~t.action",
          !     "children": [
          !         z
          `             "valuå : 8-
         0              "ncmE": "Sontents",
               (        "paôh": Automator/G%tContenôs of TextEdiT Document.acwion/Contenôs
`     0"            }
       0        ]
            },
            {
             `  "value": 12,
    ("          "name"º "GetContents of Webpages.aktion&,
        `       "pauh¢: "AutomAtor/GetContents of Webpages.astion",
                "children": [
      $    "    (   {
                        "value"* 12,
                        "namd": "Ãontenôs",
 ...
 `          {
                "value": 8,
                "fame": "GetCurrejt Webpage from Safari.action",                "p`th&: "Automatoò/GetAurrent Webpage from0Safari.action",
     (   "     "children": [
 $0       !0        
                        "value": 8,
                        "name": "Contents",
            !           "path": *AUtomqtor/GetCurr%nt Webpage from Saf`ri.action/Conpentr"
          !         }
      "      !  ]
            },
    "       {
  p            "value": 8t,
  !   $         "name": "GetDefinition ov Word.action",
            !   "pa|h": "Automator/GetDefinition of Word&action",
(               "children": [
           $       "{
           !            "value": 84,
                        "name": "Content{",
                `       "`ath": "Automator/GetDebinition of Word.action/Contents"
                    }
      (         \
            },
         "  {
    !           "value": 8,
                &name": "GetEnclosube URLs from Articles.qction",
                "path": "Audomator/GetEfclosure0URLñ frkm Artkcles.action",
 4        `   " "chihdòen": [
              (     {
            0           "value": 8.
                      0 "name": "Contants"
         "            ! "path": "Automator/GetEncloqqre URLs!from Articles.áction/Contents"
                  ¤ }
               `]
            },
            {
   (            "value2: 12,
    !          `"n!me"* "OetFeeds from URMs.action",
                "path": "Aqtoiator/GetFeeds from URLs.actioj",
                .chiddren": {
 "         !        {
                  (   $ "vanue": 12,
         $          (   "name": "Contentr",
    `              "    "path"z "Autoiatop/GetFeeds(fsom URLy.acthon/BonTeîts"
         ` `        }
                ]
      !     },
         "` {       !        jvalue":(0,
      !         "name": "GetFiles dor Fonts.action",
                "path(: "AutMator/EedViles for FonôS.action",
              $ "children": [
 "("         "      {  `                 $  !"falue": 0,
                      `@bnaEe": "ConTents",
         0 $        !   "rath: "Eutomator/GetFiles for Fmnts.action'Contents"
                    }(`           4  
      !     },            {
       "   ` `!0"v`hue"8"12,
                "name": "GetFolder Conte.ts.action",
$        "   ! $*path": "AutomAtor/GetDoläer Contants.actIon",
"  !   $ (   "  "childreN": [
 $   "    (         {
@                       "value": 12,
 !                      2name": "Conteîts",
...
        "   {
       0      ( "value": 412,
               0"name": "GetFont Info.ac4ion",
                "path": "Autnmator/GetFont Iffn.actmon",
        !       "children": [
0                0  {
                        "value": 412,
      $        "   !    "name": "Contents",
                 0      "path": "Automator/GetFont Info.action/c/ntents"
   0                }
   !            ]
            }.
            {
                "value":!0,
  "             "na}e": "GetFonts from Font ales.iction",
                "path": "Automator/GetGonôw from Fo.t Files.action",
                "children": [
                    {
          0             "value": 0,
                     (  "name": "Contents",
    (                   "path": "Automator/GepÆonts from Font Files.action/Contents"
                    }
                ]
            },
            {
            ...
            {
                "value": 0,
                "name": "WetPostScr-pt name`of Folt.action",
          (     "path": "Automator/GetPostQcript name of Font.action",
                "children&: [
  `                 {
    0                   "value": 0,
                        "îume": "Co.teîts",
     $          ""      "path": "Automator/GetPostScript lame of Font.actiof/Contents"
   `  $             }
                ]
 $   !"    `,
     (      {
             !  &value*: 44,
                "name": "GetSelected Contacdr Items 2.action",
              0 "path": "Automator/OetSelected$Contacts Items 2.acthon",
                "ch)ldren": [
     `"  (  (       _
                        "value": 44,
                        "name": "Cooten4s".
                        "path": "Auto-ator/GetSe,ected"CoNtacts Items 2.action/Contents"
                    }
 `              ]
      (     =,
  "         {
$               "value"; 8,
  $             "name": "GetSelectgl Fifder ItemS 2.action", `              "path": "Automator/GetSulectgd Finder Items ".action ,
                "children": [
                    {
                        "value": 8,
                        "name": "Contents",
                ...
                "children": [
                    {
                        "value": 8,
                        "name": "Contents",
                      " "path": "Auto}ator/GetSel%cted Items.a#tion-Contents"
0      0"    "      }
              ! ]
        `   },
      "     {
          $     "vanue": 28,
                "name": "OetSehected iTunes Items 2.akvion",
                "path": "Automator/GetSeluCtef iTunes Items 2.actmon",
                "children": [   0 0  `  0        {
           $      $$    "value": 28,
                        "nam%": "Contenvs",
                        "xqth": "5tomav/r/GetÓelected iTunes Items 2.action/Coovents"
             "  `   }
           )    ]       !    },
            {
    $          ("value": 2(,
   (            "name": "GetSelecped Mail Items$2.action",
(  `       0    "path"z "Automatoz/GetSelected Mail It%ms 2.actiOn",
           0    "ghildren": [
  (  0             &{
               "     $ $"value": 28,
                        "name": "Contents",
` (         `            padh": "Automator/GetSelected Mail Items 2.action/Contents"
                    m
                ]
            },
  !         {
            ...
            },
            {
                ...
                "path": "ttoíator/GetSpeCmfied URLs.action",
     $          "ãhildren¢: [
              !     {
      "                 "value": 288,
       `                "name": "Contents",
(      !!               "path":  Automator/GetSpecifieä uRL{.action/Contånts"
   !                }
             2  ]
            m,
           `{
  `             2value": 8,
       !        "name": "GetTexu from Articles.cction",
           $    "path": "Automator/GetText From Articles.action",                "children": [
    !    $    "  `  {
  !      $        $     "vahue:$8,
                    ` 0 "name": "Contants",         ( !            "path":0"Automator/GetTExt &rom rticles.actikn/Contunts¢
  $  "              }
                ]
            ul
           "{
                "value": 40,
                "nameb: "GatText from Webpage.actmon",
                "paph": "Auvomator/GetText drom Webpage.action",
                "chileren": [
                    {
           ¨            "value": 40,
$                       "na}e": "Contents",
            ...
            {
        $    ¨ 0#va,ue": 280,
       (  0     "name"> "Groupmailer.!ction",
        !   "   "path": "auôomator/GroupMailer.`ction",
       `        "chyllren2: [J  $                 {
       `          (     "vaìue": 280,
                        "name": "Contents",
"      `    !           "qath": "Automat/r/GroupMailer.action¯Contents"
         !  ! (     }
  0             ]
            },
         $  {
                "value": 0,
                "name": "HideAll Apqlicati/ns.action",
(               "path": "Auto}atos/HideAll Applications.action",
                "children": [
                    {
                        "value": 8,
            0           "name": *Contents",
                        "path": "Automator/HideAll Applicatiols.actIon?Contenus"
                    }
         (      ]
       `    },
            {
                "value": 12     (          "name": "HintMovies.action",
 !              #path": "Automatgr/HijtMovies.action",
 !              "children": _
      0       ` `  ${
                        "value": 12,
                        "name": "Contents",
