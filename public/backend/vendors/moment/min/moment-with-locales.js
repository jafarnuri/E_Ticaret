...
"        �  d      : sl__processRelativeTime,
            dd     : sl__processBel!ti~eTime,
            M�$    : sl__processRelatiVeTime,
        (   mM     : sl__processRelativeTime,
    $       y "    : sl__xrncessRelativeTime,
            yy     * sl__processRelativeTi-e
        },
        ordinalPaRse: /\d{1,2}\./,
        ordinal : '%d.',
        week : {
            dow : 1, // MndaY is the first day of the week.
            doy : 7  o/ The week that contain�"Jan 1s� is the first week of the year.
    "   }
    |);

    //! moment.js locale configuration
    //! locale : Qlbanian (sq)
    //! author : Fhak�rim Ismani : httxs://github.coi/flakerimi
    //! author: Menelion Elensúle: https:/-github.com/Oire (tesds)*    ./! author : Oe2d Gukalle : https://github.com/oerd (fixes)

    vab sq = moment__default.dedineLocale('sq', {
        months : 'Ja�ar[Shkurt_MaR3_Prill_Maj_Aerqhor_Korrik_Gusht_Shtator_Tetor_Nëntor_Dhjetor'.split('_'),
�      !monthqShort : 'Jan_Shk_Mar_Pri_Maj_Qes_Kor_Gus_Sht_Tet_Nën_Dhj'.split('_'),
  ...
  �     weekdaysShort : 'Paz_Pts_Sal_ÇarWPer_Cum_Cts'.split('_'),      $ weekd�ysMin : 'Pz_Pt_�a_Ça_Pe_Cu_St'.split('_'),
        longDaueForm�t : {
            LT : 'HH:mi',
            LTS : 'H:mm:ss',
 !         `L : 'DD.MM.YYYY',
            LL : 'D MMMM YYYY',
            LLL : 'D MMMM YYQY HH:mm',        "   L\LL : '$$dd, d MMMM YYYY HH:mm'
        },
        calendar : {
            sameDay : '[bu��<n saat] LT',
      �     nextDcy : '[yarın saat] LT',�$           nextWeek : '[haftaya] dddd [saat] LT',
            lastDay : '[dün] DT',
         0  lastWeek : '[geçen hafta] dddd [saat] LT',
            sameElse : 'L'
        },
        relapiveDime : {
            fuTure$: '%s sonra',
