...
@section('content')
 ...
 <div class="right_col" role="main">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    @if(Session::has("status"))
                     ...
                     @endif
                    <form action="{{route('logoupdate')}}" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
                    @csrf
   ...
   <form action="{{route('resimupdate')}}" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
   @csrf
                      <div class="form-group">
                    ...
                    <form action="{{route('genelayarupdate')}}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                         @csrf
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="{{$ayarlar->ayar_title}}" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="{{$ayarlar->ayar_description}}" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="{{$ayarlar->ayar_keyword}}" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="{{$ayarlar->ayar_author}}" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
