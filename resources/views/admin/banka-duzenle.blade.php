      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="{{url('/bankupdate/'.$banka->id)}}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
            ...
            @csrf
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  value="{{$banka->banka_ad}}" placeholder="Banka adını giriniz" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  value="{{$banka->banka_iban}}" placeholder="Banka IBAN giriniz" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  value="{{$banka->banka_hesapadsoyad}}" placeholder="Ad Soyad Giriniz" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
