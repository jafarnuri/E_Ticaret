      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="{{url('/kullaniciupdate/'.$kullanici->id)}}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
            @csrf
             ...
             <div class="form-group">
                ...
                <input type="" id="first-name"  name="created_at" disabled="" 
                value="{{$kullanici->created_at}}" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="kullanici_tel"
                   value="{{$kullanici->kullanici_tel}}" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="kullanici_adsoyad" 
                   value="{{$kullanici->kullanici_adsoyad}}" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  value="{{$kullanici->kullanici_mail}}" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
