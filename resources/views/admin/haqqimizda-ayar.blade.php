                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    @if(Session::has("status"))
                     ...
                     @endif
                     <form action="{{route('logoguncel')}}" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
                    @csrf
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <img width="200"  src="{{asset('dimg/haqqimizda/'.$haqqimizda->haqqimizda_logo)}}" alt="">
                    ...
                    <form action="{{route('haqqimizdaupdate')}}" method="POST"  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      @csrf
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea  class="form-control col-md-7 col-xs-12" id="first-name" name="haqqimizda_icerik">{{$haqqimizda->haqqimizda_icerik}}</textarea>
                        </div>
                      </div>
